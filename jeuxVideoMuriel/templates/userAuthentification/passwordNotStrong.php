...
/*==================== affichage du formulaire d'inscription pré-rempli 
                                  et demande de changer le mot de passe ====================
*/
...
<form action="/jeuxVideoMuriel/index.php?action=createUser" class="userForm" method="post">   
...
<script>
    ...
    errorRetry.textContent = "Le mot de passe n'est pas assez robuste.";
    ...
    window.onload = function() {
        ...
        if (passwordInput) {
            ...
            const length = passwordInput.value.length;         // Longueur du texte
            passwordInput.setSelectionRange(length, length);   // Place le curseur à la fin
        }
    };
</script>
<?php 
