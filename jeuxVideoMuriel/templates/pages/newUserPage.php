...
<form action="/jeuxVideoMuriel/index.php?action=newGameSelected" class="gamesForm" method="post">   
...
<form action="/jeuxVideoMuriel/index.php?action=mainPage" method="post">   
