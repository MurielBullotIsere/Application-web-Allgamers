...
?>
    ...
    <div class="buttonsArea orangeColor">
        ...
        <form action="/Application-web-Allgamers/index.php?action=connection" method="post">      <!-- envoie, par l'url, "action" avec une valeur -->
            <button type="submit" class="buttonLandingPage orangeColor">Connexion</button>
        </form>

        <!-- bouton pour aller au formulaire d'inscription -->
        <form action="/Application-web-Allgamers/index.php?action=inscription" method="post">
