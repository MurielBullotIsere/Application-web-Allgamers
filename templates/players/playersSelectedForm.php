...
if (!empty($listOfGamesSelected) && $_SESSION['playerSelectionCriteria']['list'] === "0") { 
    ...
    // si l'utilisateur a sélectionné au moins 1 jeu favori, afficher un choix à faire entre les 2 listes -->
        ...
        <div class="twoChoices">
            <form action="/Application-web-Allgamers/index.php?action=chooseGamesSelected"  method="post">
                <button class="twoChoicesButton" type="submit">Choisir parmi vos jeux sélectionnés</button><br>
            </form>
            <form action="/Application-web-Allgamers/index.php?action=chooseFavoriteGames"  method="post">
...
<form action="/Application-web-Allgamers/index.php?action=playerSelectionFormFilled"  class="gamesForm" method="post">
    <?php
